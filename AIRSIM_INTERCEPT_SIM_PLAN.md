...
本方案面向科研仿真验证，使用 AirSim 构建入侵无人机、拦截无人机、地面/中心节点和高空系留侦察无人机共同参与的对抗场景，验证地面雷达探测、图像识别、目标配准、融合跟踪、导引拦截和虚拟命中判定的完整闭环。
...
- 正常状态由中心节点统一融合、统一分配、统一评估；高空系留侦察无人机作为二级区域节点，健康时提供高视角图像/航迹 cue，中心失效时优先接管局部协调。
