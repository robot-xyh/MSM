...
- 剩余 P1 聚焦更多真实 AirSim 多 seed/N-v-N 数据和 review labels，形成 coverage/funnel/gimbal/projection/gate/stable registration/not-registered/D7 reject 长期趋势；D6 继续只消费日志，不参与控制，也不从 `2v2/5v5` 场景名推断规模。
