...
- 子模块自测结果：D1 28 passed；D2 28 passed；D3 47 passed；D4 75 passed；D5 73 passed；D6 34 passed；D7 40 passed；AirSim runtime 55 passed。D2、D6、runtime 各有 matplotlib Axes3D 环境 warning，均不构成 P0。
