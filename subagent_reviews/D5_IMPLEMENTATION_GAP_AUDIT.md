...
| 当前源码三种子集成与 D6 聚合 | **P1 开放** | 本轮只重放 seed 42000 冻结日志。main 需在当前源码复跑 `42000-42002` 完整系统；D6 需联合展示阶段耗时和 D5 快照操作数。 |

当前源码通过 `544 passed in 155.17s`。没有新增 P0，没有改变检测/相机频率、候选预算、几何/友方/身份/版本/唯一性门控、AirSim 或在线学习权限。
