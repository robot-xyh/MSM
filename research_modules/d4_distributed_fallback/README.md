...
- 2026-07-20 当前 D4 全量测试为 365/365 项通过；其中 23 项区域 authority 合同、49 项区域建议/学习/消费合同和 13 项 episode dataset 合同均零失败。dataset 还覆盖伪造投影/authority fence、三层 owner 回读、manifest inventory/split 一致性；建议图增加 200-region 路径。2026-07-15 的 280/280、区域合同阶段 303/303、建议管线阶段 335/335、消费合同阶段 350/350 和更早 278/278 保留为历史证据。本轮未运行新 AirSim episode，也未形成正式训练数据、checkpoint 或性能结论，真实链路、学习模型 20 个未见 seed 验收、误降级率、恢复时间和物理任务连续性仍开放。
