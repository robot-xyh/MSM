#!/usr/bin/env python3
"""Build the three-source eight-region D4 read-only shadow candidate."""
...
from d4_distributed_fallback.region_resource_eight_region_candidate import (
    build_region_resource_eight_region_readiness_candidate,
)
...
def main() -> int:
    ...
    result = build_region_resource_eight_region_readiness_candidate(
        ...
        json.dumps(
            {
                ...
                "readiness_dataset_sha256": manifest[
