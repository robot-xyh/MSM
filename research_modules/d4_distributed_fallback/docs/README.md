...
2026-07-21 文档状态新增保留 seed 配对干预合同：规则 control 与隔离 candidate treatment 的 specification、arm evidence 和 manifest 已实现并完成 20/20 专项、469/469 全量回归；正式 20-seed episode 和 D6 outcome sidecar 尚未运行。详细边界见算法文档的“同 seed 配对干预”、模块计划 0.0 节和实验报告。
