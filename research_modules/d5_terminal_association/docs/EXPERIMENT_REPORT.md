...
短/长逐帧业务哈希分别为 `14b86bee...d9d1` / `7f212c56...54e4`，最终 binding 哈希为 `8cd7bb99...6591` / `20b3680b...d61f`，操作数哈希为 `a8e7a6dc...2b4` / `2577b181...fcf`。在线真值使用与全局 ID 改写为 0。当前源码 D5 全量测试为 `544 passed in 155.17s`。本节不包含当前源码的三种子完整系统或 AirSim 复跑；正式性能结论仍需 main/D6 的预注册多 seed 验证。
