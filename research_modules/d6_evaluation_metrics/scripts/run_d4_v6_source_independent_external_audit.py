#!/usr/bin/env python3
"""Run the read-only D6 audit of the frozen D4 v6 external evaluation."""
...
from d6_evaluation_metrics.d4_v6_source_independent_external_audit import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = audit_d4_v6_source_independent_external(inputs)
    outputs = write_d4_v6_external_audit_report(args.output_dir, result)
