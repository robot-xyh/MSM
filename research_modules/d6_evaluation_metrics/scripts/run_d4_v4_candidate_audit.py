#!/usr/bin/env python3
"""Run the independent D6 audit for an unregistered D4 v4 candidate."""
...
from d6_evaluation_metrics.d4_v4_candidate_audit import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    inputs = load_d4_v4_candidate_audit_inputs(
        args.input_spec,
