#!/usr/bin/env python3
"""Run the strict D6 audit for D4 readiness-v3 isolated paired evidence."""
...
from d6_evaluation_metrics.d4_v3_isolated_paired_audit import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    paths = write_d4_v3_isolated_paired_audit(args.output_dir, result)
