...
2026-07-22 的快速基准四档各 5 seed，已形成有可用性和 95% 自助区间的 development 结果；
同日 200 对 200 全栈结果只有 1 seed 和 2.2 s 世界时间。两者均来自脏工作树。前者不证明完整
系统精度和物理闭环，后者不证明长时 claim 有界性或实时性能。只有 clean commit、预先冻结
输入、足够 seed 和对应证据层的完整指标才能升级为正式结论。
