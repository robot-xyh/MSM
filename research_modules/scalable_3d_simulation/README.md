...
提交 `492979ee122610dac6c503c1aa0f91cef78251ae` 已完成 20、50、100、200 四档 clean-source
校准，每档 seed 42000-42004，共 20 个 2.2 秒 episode。20/20 状态有限，在线真值使用为 0。
平均实时倍率依次为 `1.362/0.491/0.185/0.068`。20 对 20 达到实时，200 对 200 平均墙钟
32.711 秒，仍未达到实时。

200 规模 D1 融合、D2 关联和 D3 分配的平均累计时间分别为 `12.103/7.555/0.870 s`。
D1 增量后验与 D3 规划证据优化已经生效，D3 不再是首要热点。下一轮优先处理 D1 扫描关联、
D2 运行期/结束关联和 main 结束收束。本批没有正式实验矩阵元数据，D6 将其归类为干净来源的
