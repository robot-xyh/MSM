...
0 次；该结果只保留为 main 尾部合并前的历史证据。设计要求是 main 逐扫描融合 D1
尾部输入，并把合并后的最终后验送 D2 一次。2026-07-25 的正式 R0 复核发现，该要求尚未
完全落实：900 个 episode 中有 5 个 delayed-noisy 尾部后验被 main 简化签名跳过，
