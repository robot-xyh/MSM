...
4. `EXPERIMENT_REPORT.md`：离线仿真结果、5/20/50/100/200 稀疏关联证据、身份合同回归、20-seed 严格身份阻断复核、active-risk seed 1005、clean-tree 结果、有界 claim/OOSM 模块测试和失败场景分析。
...
7. `AIRSIM_INTEGRATION_PLAN.md`：AirSim 离线回放接入计划，以及 D1 观测谱系、版本化 claim ledger、整帧 OOSM adapter、部分身份诊断和 main/D6 持久化字段要求。
