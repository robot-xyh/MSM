...
2. `../PLAN.md`：研发计划和问题定义。
3. `ALGORITHM_AND_IMPLEMENTATION.md`：二维兼容主线、六维稀疏 GNN/Hungarian、JPDA/MHT、航迹生命周期、主动降级风险信号和指标说明。
4. `EXPERIMENT_REPORT.md`：离线仿真结果、5/20/50/100/200 稀疏关联证据、图表和失败场景分析。
